...
// ── DATABASE ────────────────────────────────────────────────────────────
const DB = [
  { name:"Lautaro Martínez",    surname:"Martinez",      club:"Inter",    league:"Serie A", role:"Attaccante",      nation:"Argentina", continent:"Sud America", age:27, value:90 },
  { name:"Nicolò Barella",      surname:"Barella",       club:"Inter",    league:"Serie A", role:"Centrocampista",  nation:"Italia",    continent:"Europa",     age:27, value:80 },
  { name:"Marcus Thuram",       surname:"Thuram",        club:"Inter",    league:"Serie A", role:"Attaccante",      nation:"Francia",   continent:"Europa",     age:27, value:75 },
  { name:"Alessandro Bastoni",  surname:"Bastoni",       club:"Inter",    league:"Serie A", role:"Difensore",       nation:"Italia",    continent:"Europa",     age:26, value:75 },
  { name:"Hakan Calhanoglu",    surname:"Calhanoglu",    club:"Inter",    league:"Serie A", role:"Centrocampista",  nation:"Turchia",   continent:"Europa",     age:31, value:55 },
  { name:"Manuel Akanji",       surname:"Akanji",        club:"Inter",    league:"Serie A", role:"Difensore",       nation:"Svizzera",  continent:"Europa",     age:29, value:50 },
  { name:"Denzel Dumfries",     surname:"Dumfries",      club:"Inter",    league:"Serie A", role:"Terzino",         nation:"Olanda",    continent:"Europa",     age:29, value:40 },
  { name:"Rafael Leao",         surname:"Leao",          club:"Milan",    league:"Serie A", role:"Ala",             nation:"Portogallo",continent:"Europa",     age:25, value:75 },
  { name:"Christian Pulisic",   surname:"Pulisic",       club:"Milan",    league:"Serie A", role:"Ala",             nation:"USA",       continent:"Nord America",age:26, value:55 },
  { name:"Tijjani Reijnders",   surname:"Reijnders",     club:"Milan",    league:"Serie A", role:"Centrocampista",  nation:"Olanda",    continent:"Europa",     age:26, value:55 },
  { name:"Mike Maignan",        surname:"Maignan",       club:"Milan",    league:"Serie A", role:"Portiere",        nation:"Francia",   continent:"Europa",     age:29, value:50 },
  { name:"Theo Hernández",      surname:"Hernandez",     club:"Milan",    league:"Serie A", role:"Terzino",         nation:"Francia",   continent:"Europa",     age:27, value:60 },
  { name:"Matteo Gabbia",       surname:"Gabbia",        club:"Milan",    league:"Serie A", role:"Difensore",       nation:"Italia",    continent:"Europa",     age:25, value:28 },
  { name:"Dusan Vlahovic",      surname:"Vlahovic",      club:"Juventus", league:"Serie A", role:"Attaccante",      nation:"Serbia",    continent:"Europa",     age:25, value:60 },
  { name:"Kenan Yildiz",        surname:"Yildiz",        club:"Juventus", league:"Serie A", role:"Trequartista",    nation:"Turchia",   continent:"Europa",     age:19, value:55 },
  { name:"Francisco Conceicao", surname:"Conceicao",     club:"Juventus", league:"Serie A", role:"Ala",             nation:"Portogallo",continent:"Europa",     age:22, value:45 },
  { name:"Andrea Cambiaso",     surname:"Cambiaso",      club:"Juventus", league:"Serie A", role:"Terzino",         nation:"Italia",    continent:"Europa",     age:24, value:50 },
  { name:"Pierre Kalulu",       surname:"Kalulu",        club:"Juventus", league:"Serie A", role:"Difensore",       nation:"Francia",   continent:"Europa",     age:24, value:35 },
  { name:"Manuel Locatelli",    surname:"Locatelli",     club:"Juventus", league:"Serie A", role:"Centrocampista",  nation:"Italia",    continent:"Europa",     age:27, value:28 },
  { name:"Paulo Dybala",        surname:"Dybala",        club:"Roma",     league:"Serie A", role:"Trequartista",    nation:"Argentina", continent:"Sud America", age:31, value:30 },
  { name:"Artem Dovbyk",        surname:"Dovbyk",        club:"Roma",     league:"Serie A", role:"Attaccante",      nation:"Ucraina",   continent:"Europa",     age:27, value:40 },
  { name:"Matías Soulé",        surname:"Soule",         club:"Roma",     league:"Serie A", role:"Ala",             nation:"Argentina", continent:"Sud America", age:21, value:35 },
  { name:"Lorenzo Pellegrini",  surname:"Pellegrini",    club:"Roma",     league:"Serie A", role:"Centrocampista",  nation:"Italia",    continent:"Europa",     age:28, value:28 },
  { name:"Mile Svilar",         surname:"Svilar",        club:"Roma",     league:"Serie A", role:"Portiere",        nation:"Belgio",    continent:"Europa",     age:25, value:20 },
  { name:"Stephan El Shaarawy", surname:"El Shaarawy",   club:"Roma",     league:"Serie A", role:"Ala",             nation:"Italia",    continent:"Europa",     age:32, value:12 },
  { name:"Romelu Lukaku",       surname:"Lukaku",        club:"Napoli",   league:"Serie A", role:"Attaccante",      nation:"Belgio",    continent:"Europa",     age:31, value:30 },
  { name:"Khvicha Kvaratskhelia",surname:"Kvaratskhelia",club:"Napoli",   league:"Serie A", role:"Ala",             nation:"Georgia",   continent:"Europa",     age:23, value:80 },
  { name:"Giovanni Di Lorenzo", surname:"Di Lorenzo",    club:"Napoli",   league:"Serie A", role:"Terzino",         nation:"Italia",    continent:"Europa",     age:31, value:22 },
  { name:"Scott McTominay",     surname:"McTominay",     club:"Napoli",   league:"Serie A", role:"Centrocampista",  nation:"Scozia",    continent:"Europa",     age:28, value:35 },
  { name:"Gianluca Scamacca",   surname:"Scamacca",      club:"Atalanta", league:"Serie A", role:"Attaccante",      nation:"Italia",    continent:"Europa",     age:25, value:35 },
  { name:"Éderson",             surname:"Ederson",       club:"Atalanta", league:"Serie A", role:"Centrocampista",  nation:"Brasile",   continent:"Sud America", age:25, value:50 },
  { name:"Giorgio Scalvini",    surname:"Scalvini",      club:"Atalanta", league:"Serie A", role:"Difensore",       nation:"Italia",    continent:"Europa",     age:21, value:45 },
  { name:"Nico Paz",            surname:"Paz",           club:"Como",     league:"Serie A", role:"Trequartista",    nation:"Argentina", continent:"Sud America", age:20, value:55 },
];

// ── ROSE (25/26) ────────────────────────────────────────────────────────
const ROSE_LIST = [
  { key:"Roma",     nome:"AS Roma",            emoji:"🐺",  giocatori:["Svilar","Ryan","De Marzi","Celik","Mancini","Ndicka","Angelino","Hermoso","Hummels","Rensch","Koné","Cristante","Paredes","Pisilli","Pellegrini","Le Fée","Baldanzi","Dybala","Soulé","El Shaarawy","Dovbyk","Shomurodov","Zalewski","Malen"] },
  { key:"Inter",    nome:"FC Internazionale",  emoji:"🔵",  giocatori:["Sommer","Martinez J.","Di Gennaro","Bastoni","Acerbi","De Vrij","Darmian","Dumfries","Dimarco","Bisseck","Akanji","Barella","Calhanoglu","Mkhitaryan","Zielinski","Asllani","Sucic","Luis Henrique","Lautaro","Thuram","Taremi","Arnautovic","Esposito","Bonny"] },
  { key:"Milan",    nome:"AC Milan",            emoji:"🔴",  giocatori:["Maignan","Sportiello","Torriani","Calabria","Tomori","Gabbia","Thiaw","Pavlovic","Hernandez","Terracciano","Bennacer","Reijnders","Fofana","Musah","Zeroli","Leao","Pulisic","Saelemaekers","Chukwueze","Jimenez","Morata","Abraham","Okafor","Jovic"] },
  { key:"Juventus", nome:"Juventus FC",         emoji:"⚪",  giocatori:["Di Gregorio","Perin","Pinsoglio","Danilo","Gatti","Kalulu","Cambiaso","Cabal","Holm","Locatelli","Thuram M.","Douglas Luiz","Koopmeiners","McKennie","Fagioli","Conceicao","Yildiz","Nico González","Vlahovic","Weah","Mbangula"] },
];
...
// Absolute epoch day (used only to derive per-game index)
const EPOCH = new Date("2025-01-01").getTime();
function epochDay(){return Math.floor((Date.now()-EPOCH)/86400000)+1;}
// todaySeed: YYYYMMDD number, stable within the day
function todaySeed(){const d=new Date();return d.getFullYear()*10000+(d.getMonth()+1)*100+d.getDate();}
// Per-game archive: each game has poolSize items cycling. Day #1 = first item ever shown.
// todayIndex(poolSize) = which item is shown today (0-based)
function todayIndex(poolSize){return epochDay()%poolSize;}
// archiveNum(poolSize) = today's 1-based archive number for this game
function archiveNum(poolSize){return (epochDay()%poolSize)+1;}
// seedForArchiveNum(num, poolSize) = seed for archive entry #num
function seedForArchiveNum(num,poolSize){
  // find the most recent epoch day that maps to this archive num
  const todayE=epochDay();
  const todayN=(todayE%poolSize)+1;
  let delta=num-todayN; // how many days back (negative) or forward
  // we want the most recent past day with this num
  if(delta>0) delta-=poolSize;
  const targetEpoch=todayE+delta;
  const base=new Date("2025-01-01");
  base.setDate(base.getDate()+targetEpoch-1);
...
// ── HEADER ───────────────────────────────────────────────────────────────
function dayToDate(day){const d=new Date("2025-01-01");d.setDate(d.getDate()+day-1);return d.toLocaleDateString("it-IT",{day:"numeric",month:"short"});}
    ...
    <div style={T.hdr}>
      ...
      {archiveNav&&<div style={{display:"flex",alignItems:"center",gap:"5px",marginRight:"8px"}}>
        ...
        <div style={{textAlign:"center",minWidth:"52px"}}>
          ...
          <div style={{fontSize:"8px",color:"#666"}}>{dayToDate(archiveNav.day)}</div>
        </div>
...
function ArchiveWrapper({gameKey,children}){
  ...
  const todayN=archiveNum(poolSize);
  const[num,setNum]=useState(todayN);
  const seed=seedForArchiveNum(num,poolSize);
  const isToday=num===todayN;
  return children({day:num,seed,isToday,
    archiveNav:{day:num,max:todayN,prev:()=>setNum(n=>Math.max(1,n-1)),next:()=>setNum(n=>Math.min(todayN,n+1))}
  });
}

// ── CALCIODLE ────────────────────────────────────────────────────────────
const COLS=[{key:"role",label:"Ruolo",w:"14%"},{key:"nation",label:"Nazione",w:"14%"},{key:"continent",label:"Cont.",w:"12%"},{key:"club",label:"Club",w:"14%"},{key:"age",label:"Età",w:"10%"},{key:"value",label:"Val.M",w:"11%"}];
...
function cS(c,w){return{width:w,flexShrink:0,borderRadius:"2px",background:CLR[c]?.bg||"#fff",border:`1.5px solid ${CLR[c]?.bg||"#e8e8e8"}`,color:CLR[c]?.tx||"#ccc",fontSize:"9px",textAlign:"center",padding:"4px 1px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"32px"};}
...
function CalciodleGame({day,seed,isToday,archiveNav,onHome}){
  ...
  return(<div style={T.app}><Hdr title="Calciodle" sub={`${label} · #${day}`} onHome={onHome} archiveNav={archiveNav}/>
    <div style={T.body}>
      ...
      <div style={{display:"flex",gap:"3px",marginBottom:"2px",paddingLeft:"66px"}}>{COLS.map(c=><div key={c.key} style={{width:c.w,fontSize:"7px",letterSpacing:"1px",textTransform:"uppercase",color:"#bbb",textAlign:"center",flexShrink:0}}>{c.label}</div>)}</div>
      {G.map((g,ri)=><div key={ri} style={{display:"flex",gap:"3px",alignItems:"center",marginBottom:"2px"}}><div style={{width:"58px",fontSize:"9px",color:"#555",textAlign:"right",paddingRight:"7px",flexShrink:0}}>{g.name.split(" ").pop()}</div>{COLS.map(c=>{const cl=eC(c.key,g[c.key],target[c.key]);const ar=aD(c.key,g[c.key],target[c.key]);return<div key={c.key} style={cS(cl,c.w)}><span style={{fontWeight:"700"}}>{g[c.key]}{c.key==="value"?"M":""}</span>{ar&&<span style={{fontSize:"8px"}}>{ar}</span>}</div>;})}</div>)}
      {!ov&&<div style={{display:"flex",gap:"3px",alignItems:"center",marginBottom:"2px"}}><div style={{width:"58px",flexShrink:0}}/>{COLS.map(c=><div key={c.key} style={cS("active",c.w)}>·</div>)}</div>}
      {Array.from({length:em}).map((_,i)=><div key={i} style={{display:"flex",gap:"3px",alignItems:"center",marginBottom:"2px",opacity:0.2}}><div style={{width:"58px",flexShrink:0}}/>{COLS.map(c=><div key={c.key} style={cS("empty",c.w)}>·</div>)}</div>)}
...
function WordleGame({day,seed,isToday,archiveNav,onHome}){
  ...
  return(<div style={T.app}><Hdr title="Wordle Cognome" sub={`${label} · #${day}`} onHome={onHome} archiveNav={archiveNav}/>
    <div style={{...T.body,maxWidth:"400px"}}>
        ...
        {Array.from({length:MAX_ATT}).map((_,ri)=>{
          ...
          return(<div key={ri} style={{display:"flex",gap:"5px"}}>
            {Array.from({length:word.length}).map((_,ci)=>{
              ...
              return(<div key={ci} style={{width:"42px",height:"42px",borderRadius:"3px",background:bg,border:bd,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"16px",fontWeight:"700",color:filled?"#fff":US.black,transition:"background 0.2s"}}>{filled?filled.c:isActive?disp[ci].trim():""}</div>);
            })}
          </div>);
        })}
      </div>
      {/* Tastiera */}
      {status==="playing"&&<div>
        <input value={current} onChange={e=>setCurrent(e.target.value.slice(0,word.length))} onKeyDown={e=>{if(e.key==="Enter")submit();if(e.key==="Backspace")setCurrent(c=>c.slice(0,-1));}} placeholder={`${word.length} lettere...`} style={{...T.ip,width:"100%",marginBottom:"8px",textTransform:"uppercase",letterSpacing:"3px",textAlign:"center",fontSize:"16px"}} autoFocus/>
...
function WordleCognome({onHome,isDaily}){
  if(isDaily){const d=archiveNum(DB.length),s=todaySeed();return<WordleGame day={d} seed={s} isToday archiveNav={null} onHome={onHome}/>;}
...
function Hangman({onHome,isDaily}){
  if(isDaily){const d=archiveNum(DB.length),s=todaySeed();return<HangmanGame day={d} seed={s} isToday archiveNav={null} onHome={onHome}/>;}
...
function ChiValeDiPiu({onHome,isDaily}){
  if(isDaily){const d=archiveNum(DB.length),s=todaySeed();return<ValoreGame day={d} seed={s} isToday archiveNav={null} onHome={onHome}/>;}
...
function Carriera({onHome,isDaily}){
  if(isDaily){const d=archiveNum(CAREERS.length),s=todaySeed();return<CarreiraGame day={d} seed={s} isToday archiveNav={null} onHome={onHome}/>;}
...
function RosaQuiz({onHome,isDaily}){
  if(isDaily){const d=archiveNum(ROSE_LIST.length),s=todaySeed();return<RosaQuizGame day={d} seed={s} isToday archiveNav={null} onHome={onHome}/>;}
